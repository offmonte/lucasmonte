...
export default function Modal({ open, onClose, ariaLabel, children, maxWidth = "lg:max-w-[60vw]" }: ModalProps) {
  useEffect(() => {
    if (!open) return;
  ...
  return createPortal(
    ...
    >
      <div
        className={`card-elevated relative max-h-[90vh] w-[92vw] max-w-[90vw] ${maxWidth} overflow-auto rounded-xl bg-background p-0 shadow-xl`}
